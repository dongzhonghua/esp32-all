...
screen_counter.set_pos(61,25)
screen_counter.set_size(33,23)
screen_counter.set_text("0")
screen_counter.set_long_mode(lv.label.LONG.WRAP)
screen_counter.set_style_text_align(lv.TEXT_ALIGN.CENTER, 0)
...
try:
    style_screen_counter_main_main_default.set_text_font(lv.font_arial_16)
...
screen_plus.set_pos(28,70)
screen_plus.set_size(33,23)
...
screen_plus_label.set_style_text_color(lv.color_make(0x00,0x00,0x00), lv.STATE.DEFAULT)
try:
    screen_plus_label.set_style_text_font(lv.font_arial_5, lv.STATE.DEFAULT)
except AttributeError:
    try:
        screen_plus_label.set_style_text_font(lv.font_montserrat_5, lv.STATE.DEFAULT)
    except AttributeError:
        screen_plus_label.set_style_text_font(lv.font_montserrat_16, lv.STATE.DEFAULT)
...
style_screen_plus_main_main_default.set_shadow_color(lv.color_make(0x21,0x95,0xf6))
style_screen_plus_main_main_default.set_shadow_opa(0)
...
screen_minus.set_pos(90,70)
screen_minus.set_size(33,23)
...
screen_minus_label.set_style_text_color(lv.color_make(0x00,0x00,0x00), lv.STATE.DEFAULT)
try:
    screen_minus_label.set_style_text_font(lv.font_arial_5, lv.STATE.DEFAULT)
except AttributeError:
    try:
        screen_minus_label.set_style_text_font(lv.font_montserrat_5, lv.STATE.DEFAULT)
    except AttributeError:
        screen_minus_label.set_style_text_font(lv.font_montserrat_16, lv.STATE.DEFAULT)
...
style_screen_minus_main_main_default.set_shadow_color(lv.color_make(0x21,0x95,0xf6))
style_screen_minus_main_main_default.set_shadow_opa(0)
